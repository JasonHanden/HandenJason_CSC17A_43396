 ...
 * File:   main.cpp
 * Author: Jason Handen
 * Created on May 11, 2021, 7:45 PM
 * Purpose: Project 1 Version 6, Functional program w/ file/console output
 */
...
void prntResult(Round[],Result*);       // print results
...
void prntResult(Round round[],Result *result){
