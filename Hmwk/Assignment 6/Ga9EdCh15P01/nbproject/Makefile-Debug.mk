...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ga9edch15p01.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ga9edch15p01.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ga9edch15p01 ${OBJECTFILES} ${LDLIBSOPTIONS}
